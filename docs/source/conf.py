...
# kedro_vertex_spark documentation build
...
from kedro_vertex_spark import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_vertex_spark"
author = "Kedro"
...
htmlhelp_basename = "kedro_vertex_sparkdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_vertex_spark.tex",
        "kedro_vertex_spark Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_vertex_spark",
        "Project kedro_vertex_spark codebase.",
        "Data-Science",
    )
]
